...
public class PatternImporter extends JDialog{
    PatternImporter(){
        ...
        infoPanel.add(new ScoreLabel("Score: " ), BorderLayout.NORTH); //Adds the label that will be used to display the score to the top of the parent panel
        infoPanel.add(new ScoreLabel("Lines: " ), BorderLayout.CENTER); //Adds the label that will be used to display the number of lines cleared to the top of the parent panel
        infoPanel.add(new ScoreLabel("Level: " ), BorderLayout.SOUTH); //Adds the label that will be used to display the level to the top of the parent panel
